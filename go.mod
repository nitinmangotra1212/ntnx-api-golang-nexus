...
require (
	...
	github.com/nutanix-core/ntnx-api-odata-go v1.0.39
...
// Local fork with GroupBy extensions (SetApply, ParseParam, IsGroupable)
replace github.com/nutanix-core/ntnx-api-odata-go => ../ntnx-api-odata-go
